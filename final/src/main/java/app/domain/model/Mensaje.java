...
public class Mensaje {
    ...
    public Mensaje(Long id, Long pilarId, String contenidoFragmentado, String contenidoReconstruido, LocalDateTime timestamp) {
        this.id = id; this.pilarId = pilarId; this.contenidoFragmentado = contenidoFragmentado;
        this.contenidoReconstruido = contenidoReconstruido; this.timestamp = timestamp;
    }
